...
#Exercises Type
Exercises=["E0","E1","E2","E3","E4","E5","E6","E7","E8","E9"]
...
for Exercise in Exercises:
 ...
 print(f"MAE Score:Train {MAE_train}, Test {MAE_test}")
 print(f"EVS Score:Train {EVS_train}, Test {EVS_test}")
 with open(resultsFile, 'a') as f:
  f.write(f"Random Forest\n")
  f.write(f"MSE: Train {mse_train}, Test {mse_test}\n")
  f.write(f"R2 Score:Train {r2_train}, Test {r2_test}\n")
  f.write(f"MAE Score:Train {MAE_train}, Test {MAE_test}\n")
  f.write(f"EVS Score:Train {EVS_train}, Test {EVS_test}\n")
